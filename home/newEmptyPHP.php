        ...
        ?>
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                  ...
                  <img class="card-img-top"  height="162" width="32" title="<?php echo $mostraProduto['produto_nome']?>  " src="./imgProduto/<?php echo $mostraProduto['produto_img']?>" alt="<?php echo $mostraProduto['produto_nome']?> ">
                <div class="card-body">
